...
CREATE TABLE "PrepIngredient" (
    ...
    CONSTRAINT "PrepIngredient_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "PrepEquipment" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    ...
    CONSTRAINT "PrepEquipment_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "MealPreparation" ADD CONSTRAINT "MealPreparation_mealId_fkey" FOREIGN KEY ("mealId") REFERENCES "Meal"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PrepStep" ADD CONSTRAINT "PrepStep_mealPrepId_fkey" FOREIGN KEY ("mealPrepId") REFERENCES "MealPreparation"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PrepIngredient" ADD CONSTRAINT "PrepIngredient_mealPrepId_fkey" FOREIGN KEY ("mealPrepId") REFERENCES "MealPreparation"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PrepEquipment" ADD CONSTRAINT "PrepEquipment_mealPrepId_fkey" FOREIGN KEY ("mealPrepId") REFERENCES "MealPreparation"("id") ON DELETE CASCADE ON UPDATE CASCADE;
