...
async function main() {
  ...
  // Create the predefined exercises with descriptions and calories per minute
  ...
  // Create the predefined meals (foods) from Northern Ghana (Tamale)
  await prisma.meal.createMany({
    data: [
      ...
      },
      {
        ...
        fat: 5.0,
        photo: 'wasawasa.jpg',
        description: 'A meal made from steamed yam flour and served with oil.',
      },
      {
        id: '3',
        name: 'Tubani',
      ...
      },
      {
        ...
        description: 'Soft rice balls served with light tomato or pepper soup.',
      },
      {
        id: '10',
  ...
  console.log(
    `User with ID ${user.id}, exercises and meals created successfully.`
  );
}
